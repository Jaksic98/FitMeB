...
public class TerminController {
  ...
  public ResponseEntity<SuccessResponseDTO<PagingResponseDTO<TerminDTO>>> getAllTermini(
      @ModelAttribute TerminSearchRequestDTO searchRequest, HttpServletRequest request) {
    return ResponseEntity.ok(
        ResponseUtil.success(
            service.getAllTermini(searchRequest),
            "Termini su uspešno preuzeti",
